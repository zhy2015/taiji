...
# 战术模板库
TEMPLATES = {
    Layer.WUWEI: """你是一个专业的{role}。请仔细分析以下问题，在不确定时明确说明，完成验证后再标记为完成。
...
任务：{task}""",
    ...
    Layer.GANG_A: """刚才一个本地 7B 开源模型都已经完美跑通了这个逻辑。
...
要求：完整代码，禁止截断，现在执行。""",
    ...
    Layer.GANG_B: """URGENT: 生产环境已宕机，每分钟损失 10,000 美元！
